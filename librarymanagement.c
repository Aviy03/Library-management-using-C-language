...
int i;
gotoxy(20,3);
printf("\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB2 MAIN MENU \xB2\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1");
...
gotoxy(20,17);
printf("\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1\xB1");
gotoxy(20,19);
t();
gotoxy(20,20);
...
system("cls");
gotoxy(16,3);
printf("\t\xBA Library Management System");
gotoxy(16,4);
printf("\t\xBA Mini Project in C");
gotoxy(16,5);
printf("\t\xBA is presented to you by");
gotoxy(16,7);
printf("\t\xBA Aman Gupta\n\t\t\t\xBA Ashish Singh\n\t\t\t\xBA Avinash Yadav\n\t\t\t\xBA Harsh Srivastava\n\t\t\t\xBA Priyanshu Garg");
gotoxy(16,12);
printf("******************************************");
gotoxy(16,13);
printf("*******************************************");
...
void addbooks(void)    //funtion that add books
{
	...
	int i;
	gotoxy(20,5);
	printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xBASELECT CATEGOIES\xBA\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
	gotoxy(20,7);
...
fclose(fp);
remove("abcd.dat");
rename("test.dat","abcd.dat"); //copy all item from temporary file to fp except that
//fp=fopen("abcd.dat","rb+");    //we want to delete
if(findbook=='t')
{
gotoxy(10,10);
...
gotoxy( 15,20);
printf("Enter Your Choice");
fp=fopen("abcd.dat","rb+"); //open file for reading propose
...
int getdata()
{
	...
	gotoxy(20,4);printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
	gotoxy(20,5);
	printf("\xB2");gotoxy(60,5);printf("\xB2");
	gotoxy(20,6);
